...
export const FESTIVAL_DETAILS = {
  name: 'المهرجان الكشفي الإرشادي السنوي الـ 30',
  subtitle: 'مجموعة المنشية الكشفية والإرشادية',
  location: 'مركز شباب منشية التحرير - عين شمس - القاهرة',
  schedule: 'اليوم الأول: افتتاح ومسابقات رقمية، اليوم الثاني: تقييمات الفيديو والأنشطة، اليوم الثالث: إعلان النتائج والتتويج',
  info: 'تجربة كشفية رقمية تجمع بين روح الفريق المعرفي، التحديات الميدانية، والذكاء الاصطناعي.',
