    ...
    <main className="app-shell p-4 text-white sm:p-6 dir-rtl">
      <div className="mx-auto max-w-6xl">
        ...
        <form onSubmit={add} className="mb-6 grid gap-3 rounded-2xl border border-slate-800 bg-slate-900/60 p-5 md:grid-cols-4">
          ...
          <select className="ai-input bg-slate-950" value={creating.type} onChange={event => setCreating({ ...creating, type: event.target.value })}><option value="auto_digital">رقمية تلقائية</option><option value="manual_judged">تحكيم يدوي</option><option value="schedule_only">فعالية زمنية فقط</option></select>
