...
try {
    ...
    await run(process.execPath, [
        path.join(scriptDirectory, 'unit-sessionRevocation.mjs')
    ]);
    ...
    await run(process.execPath, [
        path.join(scriptDirectory, 'unit-reportCatalog.mjs')
    ]);
    ...
    await run(process.execPath, [
        path.join(scriptDirectory, 'unit-judgeEquivalentCompetitions.mjs')
    ]);
    ...
    await run(process.execPath, [
        path.join(scriptDirectory, 'integration-program-propagation.mjs')
    ]);
