const standardCriteria = JSON.stringify([
  { key: 'content', label: 'جودة المحتوى', maxScore: 40 },
  { key: 'creativity', label: 'الفكرة والإبداع', maxScore: 30 },
