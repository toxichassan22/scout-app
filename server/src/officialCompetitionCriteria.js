...
export const OFFICIAL_CRITERIA_BY_SLUG = {
  ...
  report_art_workshop: c([['participation', 'مشاركة', 1], ['members', 'عدد (2 فرد)', 1], ['uniform', 'زي', 1], ['report', 'تقرير', 1], ['attendance', 'توقيت حضور', 1], ['workshopTime', 'توقيت الورشة', 5], ['usage', 'استخدام', 10], ['innovation', 'شرط الابتكار', 10], ['quality', 'إخراج وجودة', 10], ['extras', 'إضافات', 5]]),
  report_art_piece: c([['deliveryTime', 'توقيت التسليم', 1], ['production', 'شرط إنتاج', 2], ['quality', 'جودة وإخراج', 10], ['usage', 'استخدام', 10], ['extras', 'إضافات وتميز', 2]]),
  ...
  report_scout_model: c([['participation', 'مشاركة', 1], ['count', 'عدد', 1], ['uniform', 'زي', 1], ['report', 'تقرير', 1], ['attendance', 'توقيت حضور', 1], ['executionTime', 'توقيت تنفيذ', 4], ['modelUsage', 'استخدام النموذج', 10], ['cycles', 'صحة الدورات', 10], ['cyclesVariety', 'تنوع الدورات', 0], ['durability', 'متانة', 10], ['multiplicity', 'تعدد', 5], ['units', 'الالتزام بعدد الوحدات', 10], ['storage', 'تشوين ونظافة', 5], ['extras', 'إضافات', 1]]),
  ...
  // Program item «تصميم فيديو دقيقتين» is judged with the official «الفيديو» sheet.
  video_design: c([['participation', 'مشاركة', 1], ['uniform', 'زي', 1], ['report', 'تقرير', 1], ['attendance', 'توقيت حضور', 2], ['videoTime', 'توقيت الفيديو', 5], ['editing', 'إخراج', 5], ['idea', 'وضوح الفكرة', 40]]),
  report_prep_video: c([['participation', 'مشاركة', 5], ['quality', 'جودة', 5], ['editing', 'إخراج', 5], ['timing', 'توقيت', 5], ['likes', 'لايك', 5], ['comments', 'تعليق', 5], ['views', 'مشاهدة', 5]]),
  report_public_service: c([['participation', 'مشاركة', 1], ['uniform', 'زي', 1], ['attendance', 'توقيت حضور', 1], ['performance', 'أداء وتميز', 47]]),
  report_first_aid: c([['participation', 'مشاركة', 1], ['uniform', 'زي', 1], ['kit', 'حقيبة إسعافات', 23]]),
  report_community_vision: c([['deliveryTime', 'توقيت تسليم', 1], ['content', 'محتوى', 1], ['photos', 'توثيق بالصور', 1], ['letters', 'خطابات', 2], ['requirements', 'شروط', 10], ['benefit', 'كيفية الاستفادة', 10]]),
  sports_1: c([['score', 'الدرجة النهائية', 100]]),
  sports_2: c([['score', 'الدرجة النهائية', 100]]),
  king_ciphers: c([['participation', 'مشاركة', 1], ['uniform', 'زي', 1], ['attendance', 'توقيت حضور', 1], ['cipher1', 'صحة وسرعة الشفرة الأولى', 10], ['cipher2', 'صحة وسرعة الشفرة الثانية', 10], ['cipher3', 'صحة وسرعة الشفرة الثالثة', 10], ['excellence', 'درجة تميز', 5], ['allCiphers', 'حل الأربع شفرات', 10], ['usedCiphers', 'الشفرات المستخدمة', 2]]),
};
...
Object.assign(OFFICIAL_CRITERIA_BY_SLUG, {
  ...
  report_ai_models: OFFICIAL_CRITERIA_BY_SLUG.report_model_presentation,
